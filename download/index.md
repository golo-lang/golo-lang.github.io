...
* [Golo 3.2.0-M6 (Bintray)](https://bintray.com/artifact/download/golo-lang/downloads/golo-3.2.0-M6.zip)
* [Golo 3.2.0-M6 (Eclipse)](https://www.eclipse.org/downloads/download.php?file=/golo/golo-3.2.0-M6.zip)
...
{% highlight groovy %}
dependencies {
  compile 'org.eclipse.golo:golo:3.2.0-M6'
  // ...
}
{% endhighlight %}
