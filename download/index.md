...
* [Golo 3.3.0-M1 (Bintray)](https://bintray.com/artifact/download/golo-lang/downloads/golo-3.3.0-M1.zip)
* [Golo 3.3.0-M1 (Eclipse)](https://www.eclipse.org/downloads/download.php?file=/golo/golo-3.3.0-M1.zip)
...
{% highlight groovy %}
dependencies {
  compile 'org.eclipse.golo:golo:3.3.0-M1'
  // ...
}
{% endhighlight %}
