...
* [Golo 3.1.0 (Bintray)](https://bintray.com/artifact/download/golo-lang/downloads/golo-3.1.0.zip)
* [Golo 3.1.0 (Eclipse)](https://www.eclipse.org/downloads/download.php?file=/golo/golo-3.1.0.zip)
...
{% highlight groovy %}
dependencies {
  compile 'org.eclipse.golo:golo:3.1.0'
  // ...
}
{% endhighlight %}
