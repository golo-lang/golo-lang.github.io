...
* [Golo 3.1.0-M2 (Bintray)](https://bintray.com/artifact/download/golo-lang/downloads/golo-incubation-3.1.0-M2.zip)
* [Golo incubation-3.1.0-M2 (Eclipse)](https://www.eclipse.org/downloads/download.php?file=/golo/golo-incubation-3.1.0-M2.zip)
...
{% highlight groovy %}
dependencies {
  compile 'org.eclipse.golo:golo:3.1.0-M2'
  // ...
}
{% endhighlight %}
